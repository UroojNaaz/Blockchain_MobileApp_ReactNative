...
const Flash3 = () => {
  return (
    <View style={styles.flash}>
      ...
      <Text style={[styles.flash1, styles.text1Typo]}>Flash</Text>
      <View style={[styles.flashInner, styles.flashInnerLayout]} />
      <Text style={[styles.recevoir, styles.text1Clr]}>Recevoir</Text>
      <View style={[styles.rectangleView, styles.rectangleViewPosition]} />
      <Text style={[styles.envoyez, styles.text1Clr]}>Envoyez</Text>
      <Text style={[styles.recentesTransaction, styles.rectangleViewPosition]}>
